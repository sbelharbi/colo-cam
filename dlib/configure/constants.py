...
ARCHS = [STDCLASSIFIER, UNETFCAM, UNETTCAM, UNETCOLOCAM, DENSEBOXNET]
...
# number of main layers: can be used to extract layerwise self-attention.
MAX_NBR_LAYERS = {
    RESNET50: 6,
    VGG16: 4,
    INCEPTIONV3: 6
...
TIME_DEPENDENCY2 = [TIME_BEFORE, TIME_AFTER, TIME_BEFORE_AFTER, TIME_RANDOM]

# sample from frames distribution:
SAMPLE_FR_UNIF = 'uniform'
SAMPLE_FR_GAUS = 'gaussian'
SAMPLE_FR_INTERVAL = 'interval'

SAMPLE_FR_DISTS = [SAMPLE_FR_UNIF, SAMPLE_FR_GAUS, SAMPLE_FR_INTERVAL]
...
# Joint rgb crf input
INPUT_IMG = 'image'  # the original input image.
INPUT_DEEP_FT = 'deep_features'  # deep features from the decoder's last layer.
INPUT_CAM_LOGITS = 'cam_logits'  # decoder output cam logits.
INPUT_DATA = [INPUT_IMG, INPUT_DEEP_FT, INPUT_CAM_LOGITS]


# lambda: joint rgb crf. how to control it? constant, or adaptive?
LAMBDA_CONST = 'constant'
LAMBDA_ADAPT = 'adaptive'

LAMBDA_STYLES = [LAMBDA_CONST, LAMBDA_ADAPT]